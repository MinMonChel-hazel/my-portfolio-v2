  ...
  return (
    <div id='skills' className='container mx-auto text-center text-white pb-20'>
        <header className='md:space-y-4 space-y-2' data-aos='fade-up' data-aos-delay='300'>
            ...
            <p className='text-base md:text-lg lg:text-xl text-center xl:px-40 lg:px-24 md:px-18 px-10'>As a frontend developer, I specialize in building responsive, user-friendly web applications using modern technologies and best practices. Here are the tools I work with the most:</p>
        </header>
